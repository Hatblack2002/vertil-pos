...
import com.vertil.pos.data.entity.CustomerEntity;
...
public final class CustomerDao_Impl implements CustomerDao {
  ...
  public CustomerDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCustomerEntity = new EntityInsertionAdapter<CustomerEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `customers` (`id`,`name`,`phone`,`email`,`address`,`notes`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfCustomerEntity = new EntityDeletionOrUpdateAdapter<CustomerEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `customers` SET `id` = ?,`name` = ?,`phone` = ?,`email` = ?,`address` = ?,`notes` = ?,`createdAt` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object insert(final CustomerEntity c, final Continuation<? super Long> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Long>() {
      ...
      public Long call() throws Exception {
        ...
        try {
          final Long _result = __insertionAdapterOfCustomerEntity.insertAndReturnId(c);
  ...
  @Override
  public Object delete(final CustomerEntity c, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __deletionAdapterOfCustomerEntity.handle(c);
          __db.setTransactionSuccessful();
  ...
  @Override
  public Object update(final CustomerEntity c, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __updateAdapterOfCustomerEntity.handle(c);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
  ...
  @Override
  public Flow<List<CustomerEntity>> observeAll() {
    final String _sql = "SELECT * FROM customers ORDER BY name";
      ...
      public List<CustomerEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new CustomerEntity(_tmpId,_tmpName,_tmpPhone,_tmpEmail,_tmpAddress,_tmpNotes,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public CustomerEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new CustomerEntity(_tmpId,_tmpName,_tmpPhone,_tmpEmail,_tmpAddress,_tmpNotes,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
