...
import com.vertil.pos.data.entity.SupplierEntity;
...
public final class SupplierDao_Impl implements SupplierDao {
  ...
  public SupplierDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfSupplierEntity = new EntityInsertionAdapter<SupplierEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `suppliers` (`id`,`name`,`phone`,`email`,`address`,`notes`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfSupplierEntity = new EntityDeletionOrUpdateAdapter<SupplierEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `suppliers` SET `id` = ?,`name` = ?,`phone` = ?,`email` = ?,`address` = ?,`notes` = ?,`createdAt` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object insert(final SupplierEntity s, final Continuation<? super Long> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Long>() {
      ...
      public Long call() throws Exception {
        ...
        try {
          final Long _result = __insertionAdapterOfSupplierEntity.insertAndReturnId(s);
  ...
  @Override
  public Object delete(final SupplierEntity s, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __deletionAdapterOfSupplierEntity.handle(s);
          __db.setTransactionSuccessful();
  ...
  @Override
  public Object update(final SupplierEntity s, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __updateAdapterOfSupplierEntity.handle(s);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
  ...
  public Flow<List<SupplierEntity>> observeAll() {
    final String _sql = "SELECT * FROM suppliers ORDER BY name";
      ...
      public List<SupplierEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new SupplierEntity(_tmpId,_tmpName,_tmpPhone,_tmpEmail,_tmpAddress,_tmpNotes,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getById(final long id, final Continuation<? super SupplierEntity> $completion) {
      ...
      public SupplierEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new SupplierEntity(_tmpId,_tmpName,_tmpPhone,_tmpEmail,_tmpAddress,_tmpNotes,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
