...
import com.vertil.pos.data.entity.AppSettingsEntity;
...
public final class SettingsDao_Impl implements SettingsDao {
  ...
  @Override
  public Object set(final AppSettingsEntity s, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfAppSettingsEntity.insert(s);
  ...
  @Override
  public Object getAll(final Continuation<? super List<AppSettingsEntity>> $completion) {
    final String _sql = "SELECT * FROM app_settings";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<List<AppSettingsEntity>>() {
      @Override
      @NonNull
      public List<AppSettingsEntity> call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
        try {
          final int _cursorIndexOfKey = CursorUtil.getColumnIndexOrThrow(_cursor, "key");
          final int _cursorIndexOfValue = CursorUtil.getColumnIndexOrThrow(_cursor, "value");
          final List<AppSettingsEntity> _result = new ArrayList<AppSettingsEntity>(_cursor.getCount());
          while (_cursor.moveToNext()) {
            final AppSettingsEntity _item;
            final String _tmpKey;
            _tmpKey = _cursor.getString(_cursorIndexOfKey);
            final String _tmpValue;
            _tmpValue = _cursor.getString(_cursorIndexOfValue);
            _item = new AppSettingsEntity(_tmpKey,_tmpValue);
            _result.add(_item);
          }
          return _result;
        } finally {
